...
namespace oz {
  ...
  class tic_tac_toes_t final : public game_t {
    ...
    struct infoset_t : public oz::infoset_t::concept_t {
      ...
      const action_vector_t pieces_P1;   // All the actions made by P1
      const action_vector_t pieces_P2;   // All the actions made by P1
      const action_vector_t history;     // All the actions made by both P1 and P2
      const int action_number;           // Total number of actions in the game
